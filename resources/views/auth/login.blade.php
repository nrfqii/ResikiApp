        ...
        <form action="/login" method="POST" class="space-y-4">
            ...
            <div class="text-center pt-4">
                <p class="text-gray-600 text-sm">Belum punya akun?
                    <a href="/register"
                        class="text-primary font-semibold hover:underline transition duration-200">Daftar sekarang</a>
                </p>
            </div>
            ...
            {{-- <div class="mt-6">
                ...
                <div class="mt-4 grid grid-cols-2 gap-3">
                    <button type="button"
                        class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition duration-200">
